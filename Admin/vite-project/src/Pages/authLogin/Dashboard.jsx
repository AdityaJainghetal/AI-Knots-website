...
//         ] = await Promise.all([
//           axios
//             .get("https://ai-knots-website-3.onrender.com/api/users")
//             .catch(() => ({ data: null })),
//           axios
//             .get("https://ai-knots-website-3.onrender.com/query")
//             .catch(() => ({ data: null })),
//           axios
//             .get("https://ai-knots-website-3.onrender.com/api/contact")
//             .catch(() => ({ data: null })),
//           axios
//             .get("https://ai-knots-website-3.onrender.com/api/technology/product")
//             .catch(() => ({ data: null })),
//           axios
//             .get("https://ai-knots-website-3.onrender.com/api/technology/category")
//             .catch(() => ({ data: null })),
//         ]);
    ...
    const fetchAllData = async () => {
      try {
        const [
          ...
          axios
            .get(
              "https://ai-knots-website-3.onrender.com/api/technology/product",
            )
            .catch(() => ({ data: null })),
          axios
            .get(
              "https://ai-knots-website-3.onrender.com/api/technology/category",
            )
            .catch(() => ({ data: null })),
          axios
            .get(
              "https://ai-knots-website-3.onrender.com/api/product/alladminproducts",
            )
        ...
        const recentBlogs = blogs.map((blog) => ({
          ...
          message: blog.title || "Untitled Blog",
