...
//     try {
//       const res = await fetch("https://ai-knots-website-3.onrender.com/api/blogcategory");
...
//   async (_, { rejectWithValue }) => {
//     try {
//       const res = await fetch("https://ai-knots-website-3.onrender.com/api/product");
...
//     try {
//       const res = await fetch(`https://ai-knots-website-3.onrender.com/api/product/${postId}`);
...
//         `https://ai-knots-website-3.onrender.com/api/product/${postId}/view`,
//         {
//           method: "PUT",
//         },
//       );
...
//       const res = await fetch(
//         `https://ai-knots-website-3.onrender.com/api/product/${postId}/like`,
//         {
//           method: "PUT",
...
//       const res = await fetch(
//         `https://ai-knots-website-3.onrender.com/api/product/${postId}/send-otp`,
//         {
//           method: "POST",
//           headers: { "Content-Type": "application/json" },
...
//     try {
//       const res = await fetch(
//         `https://ai-knots-website-3.onrender.com/api/product/${postId}/verify-otp`,
//         {
//           method: "POST",
//           headers: { "Content-Type": "application/json" },
...
//     try {
//       const res = await fetch(
//         `https://ai-knots-website-3.onrender.com/api/product/${postId}/comment`,
//         {
//           method: "POST",
//           headers: { "Content-Type": "application/json" },
